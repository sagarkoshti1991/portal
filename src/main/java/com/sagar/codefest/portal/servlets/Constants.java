...
/**
 * Holds constants that cross servlets. These are categorized using static
 * nested classes.
 */
public abstract class Constants {
	...
	/**
	 * Standard response messages. These strings will constitute the entirety of the
	 * response body.
	 */
	public abstract class ResponseMessages {
		...
		/**
		 * User is logged in (returned after successful sign-in/sign-up, or from an auth
		 * check).
		 */
		...
		/**
		 * The supplied username and/or password were incorrect. We do not differentiate
		 * between the two cases as a security measure.
		 */
		...
		/**
		 * New user attempted to login via normal signin page, needs to go to
		 * signup-confirm page.
		 */
