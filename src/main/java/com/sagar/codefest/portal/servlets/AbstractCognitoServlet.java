...
import com.sagar.codefest.portal.util.CredentialsCache;
 ...
 */
public abstract class AbstractCognitoServlet extends HttpServlet {
	 ...
	 * Note that refresh token is optional -- on a refresh, we just get a new access
	 * token.
	 * <p>
	...
	/**
	 * Writes the response message. All responses use status code 200; the client
	 * must look at the message to determine its action.
	 */
